  ...
  return (
    <main ref={containerRef} tabIndex={0} onKeyDown={handleKeyDown} className="container py-6 space-y-6">
      ...
      <div className="sticky top-14 z-30">
        <div className="relative border bg-white/75 backdrop-blur supports-[backdrop-filter]:bg-white/75 shadow-[var(--shadow-elegant)] rounded-md">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {items.map((d, idx) => {
              ...
              return (
                ...
                >
                  <Card className={cn("transition-colors hover:border-primary/30 group", isSelected ? "bg-muted" : "")}
                  >
