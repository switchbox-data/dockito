          ...
          <div ref={scrollerRef} className="relative z-10 p-2 md:p-3 overflow-x-auto min-w-0">
            ...
            <div className="flex items-center gap-2 md:gap-3 min-w-0 overflow-x-auto">
              ...
              <Popover open={industryMenuOpen} onOpenChange={setIndustryMenuOpen}>
                ...
                <PopoverContent className="w-[600px] p-0 z-[60] bg-white/75 backdrop-blur supports-[backdrop-filter]:bg-white/75 border max-h-[500px] overflow-y-auto" align="start">
                  <div className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="text-sm font-semibold">Industries</h3>
                      <div className="flex items-center gap-2">
                        {selectedIndustries.length > 0 && (
                          <Button variant="outline" size="sm" className="border-gray-300 hover:border-gray-300" onClick={() => setSelectedIndustries([])}>Clear all</Button>
                        )}
              ...
              <Popover open={typeMenuOpen} onOpenChange={setTypeMenuOpen}>
                ...
                <PopoverContent className="w-[800px] p-0 z-[60] bg-white/75 backdrop-blur supports-[backdrop-filter]:bg-white/75 border max-h-[600px] overflow-y-auto" align="start">
                  <div className="p-4">
                    <div className="flex items-center justify-between mb-3">
              ...
              {lockedOrg && (
                <Popover open={relationshipOpen} onOpenChange={setRelationshipOpen}>
                  ...
                  <PopoverContent className="w-[300px] p-0 z-[60] bg-white/75 backdrop-blur supports-[backdrop-filter]:bg-white/75 border" align="start">
                    <Command>
                      <CommandList>
                        <CommandGroup>
      ...
      {(selectedIndustries.length > 0 || docketTypes.length > 0 || docketSubtypes.length > 0 || petitioners.length > 0 || normalizedSearch || relationshipTypes.length > 0 || isStartDateModified || isEndDateModified) && (
        ...
        <div className="relative flex flex-wrap items-center gap-2 text-sm px-1">
          ...
          <div className="flex flex-wrap items-center gap-2 flex-1">
            ...
            <Badge key={`ind-${ind}`} variant="secondary" className="px-2 py-1 bg-white border border-border">
          ...
          {docketTypes.map((t) => (
            <Badge key={`type-${t}`} variant="secondary" className="px-2 py-1 bg-white border border-border">
              <div className="flex items-center gap-1.5 mr-1">
          ...
          {docketSubtypes.map((st) => (
            <Badge key={`subtype-${st}`} variant="secondary" className="px-2 py-1 bg-white border border-border">
              <div className="flex items-center gap-1.5 mr-1">
                <Shapes size={12} className="text-muted-foreground" />
          ...
          {lockedOrg ? null : (
            petitioners.map((p) => (
              <Badge key={`pet-${p}`} variant="secondary" className="px-2 py-1 bg-white border border-border">
                <div className="flex items-center gap-1.5 mr-1">
          ...
          {lockedOrg && relationshipTypes.includes("petitioned") && (
            <Badge variant="secondary" className="px-2 py-1 bg-white border border-border">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {items.map((d, idx) => {
              ...
              return (
                ...
                >
                  <Card className={cn("transition-colors hover:border-primary/30 focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 ring-offset-background group bg-white/95", isSelected ? "bg-muted" : "")}
                  >
