                  ...
                  >
                       <CardContent className="p-4 space-y-1">
                         ...
                         <div className="flex flex-wrap gap-1">
                           ...
                           {d.docket_subtype && <Badge variant="outline" className="border-gray-300 bg-background">{d.docket_subtype}</Badge>}
                         </div>
                         <div className="flex flex-col items-end gap-1">
                           {d.industry && (
                             <Badge variant="outline" className="inline-flex items-center gap-1.5 border-gray-300 bg-background">
                               {(() => {
